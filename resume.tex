...
\textbf{Optiver} & \textbf{Apr 2008 -- Present}\\
...
Also experienced with Python and database usage through SQL (on Microsoft SQL Server in particular).}
\item {Development tools: Visual Studio, vim, Subversion, automated testing (using Boost Test), bjam, and assorted Linux utilities.}
