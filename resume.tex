...
\item {Experienced database user (Microsoft SQL Server, PostgreSQL, and sqlite).} 
\item {Considerable practice at using Linux utilities, e.g. awk, to speed prototyping work.}
\item {Able to be productive with many development tools: Visual Studio, vim, git, Subversion, Perforce.}
